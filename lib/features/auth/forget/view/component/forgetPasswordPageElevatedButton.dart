...
class forgetPasswordPageElevatedButton extends StatelessWidget {
  forgetPasswordPageElevatedButton({super.key, required this.controller});
      ...
      child: BlocBuilder<ForgetCubit, ForgetState>(
        builder: (context, state) {
          return ElevatedButton(
            onPressed: () {
              controller.onPressedSendCode(context);
            },
            child: Text(
                "Send Code",
                style: TextStyle(
